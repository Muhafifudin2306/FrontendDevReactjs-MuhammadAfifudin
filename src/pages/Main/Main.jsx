...
function MainPage() {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        if (response.data.length > visibleRestaurants) {
          setLoadMore(true); // Aktifkan tombol "Load More" hanya jika ada lebih banyak data
        }
      })
      .catch((error) => {
  ...
  const loadMoreData = () => {
    setVisibleRestaurants(visibleRestaurants + 4); // Menambah jumlah data yang ditampilkan sebanyak 4
  };
                ...
                <div className="detail-card w-100 bg-white rounded-bottom p-3">
                  ...
                  <div className="detail-facility mb-3">
                    ...
                    <div className="facility-item mb-1">
                      ...
                      <span className="mx-2 fs-8">{restaurant.price_name}</span>
                    </div>
                    <div className="facility-item mb-1">
                      {restaurant.status === 1 ? (
                        <span>
